package cn.whpu.demo04.exercise.two;
import java.util.*;
...
public class DateExample
{
    public static void main(String args[ ])
    {
        ...
        String s1=String.format("%tY年%tm月%td日",calendar,calendar,calendar);  //将calendar的时间设置为yearOne年monthOne月dayOne日
        long timeOne=calendar.getTimeInMillis();     //calendar表示的时间转换成毫秒
        calendar.set(yearTwo,monthTwo-1,dayTwo);                //将calendar的时间设置为yearTwo年monthTwo月dayTwo日
