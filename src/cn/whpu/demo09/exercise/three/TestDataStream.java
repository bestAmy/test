package cn.whpu.demo09.exercise.three;
...
public class TestDataStream {
    public static void main(String[] args) throws IOException {
        ...
        DataOutputStream output = new DataOutputStream(new FileOutputStream("file/temp.dat"));
        ...
        DataInputStream input =
                new DataInputStream(new FileInputStream("file/temp.dat"));
